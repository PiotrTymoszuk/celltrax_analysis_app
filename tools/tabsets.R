                      ...
                      column(width = 3,
                             ...
                             numericInputIcon(inputId = 'y_min_tracks_raw',
                                              ...
                                              icon = list(icon(name = 'resize-vertical',
                                                               lib = 'glyphicon'),
                                                          'min')),
                             actionButton(inputId = 'tracks_raw_refresh',
                                          label = 'reset',
                      ...
                      column(width = 3,
                             ...
                             numericInputIcon(inputId = 'y_min_tracks_norm',
                                              ...
                                              icon = list(icon(name = 'resize-vertical',
                                                               lib = 'glyphicon'),
                                                          'min')),
                             actionButton(inputId = 'tracks_norm_refresh',
                                          label = 'reset',
                                          icon = icon(name = 'refresh',
                                                      lib = 'glyphicon'))),
                      column(width = 3,
                      ...
                      column(width = 3,
                             ...
                             numericInputIcon(inputId = 'y_min_vectors_raw',
                                              ...
                                              icon = list(icon(name = 'resize-vertical',
                                                               lib = 'glyphicon'),
                                                          'min')),
                             actionButton(inputId = 'vectors_raw_refresh',
                                          label = 'reset',
                                          icon = icon(name = 'refresh',
                                                      lib = 'glyphicon'))),
                      column(width = 3,
                      ...
                      column(width = 3,
                             ...
                             numericInputIcon(inputId = 'y_min_vectors_norm',
                                              ...
                                              icon = list(icon(name = 'resize-vertical',
                                                               lib = 'glyphicon'),
                                                          'min')),
                             actionButton(inputId = 'vectors_norm_refresh',
                                          label = 'reset',
                                          icon = icon(name = 'refresh',
                                                      lib = 'glyphicon'))),
                      column(width = 3,
...
# Tab 6: Hotelling's test and plots ------
